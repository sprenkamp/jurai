...
class Finetune:
    ...
    def train(self):
        ...
        training_args = transformers.TrainingArguments(
                    ...
                    report_to = self.model_config["wandb_project"] if self.model_config["wandb"] else False, #TODO - Add wandb
                    run_name = f"{self.model_config['wandb_project']}-{datetime.now().strftime('%Y-%m-%d-%H-%M')}" if self.model_config["wandb"] else None,
